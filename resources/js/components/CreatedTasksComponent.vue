                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              ...
                              <button type="button" class="close" @click="editTask = null; modal=false; ">
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" :class="{ 'is-invalid': errors.description }" v-model="form.description" rows="2"></textarea>
                              ...
                              <div class="form-group row" >
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="date" class="form-control" :class="{ 'is-invalid': errors.date_till_done }" v-model="form.date_till_done"/>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="form-control" :class="{ 'is-invalid': errors.assignee_id }" v-model="form.assignee_id">
                              ...
                              <div class="form-group row" >
                                  <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" :class="{ 'is-invalid': errors.status }" v-model="form.status">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control to-capital-first" :class="{ 'is-invalid': errors.priority }" v-model="form.priority">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" :class="{ 'is-invalid': errors.project_id }" v-model="form.project_id">
                                  <option v-for="project in this.projects" :value="project.id" :key="project.id">
                                  {{ project.title }}
                                  </option>
                                </select>
                ...
                <table class="table-striped table-responsive">
                  ...
                  <tbody>
                    <tr v-for="task in project.tasks" :key="task.id">
                      ...
                      <td style="width: 20%">{{ task.date_till_done | monthDay}}</td>
                      <td style="width: 20%">{{ task.status }}</td>
                      <td class="to-capital-first" style="width: 20%">{{ task.priority }}</td>
